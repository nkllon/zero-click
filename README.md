...
- [Research & references](https://github.com/nkllon/zero-click/blob/content/.content/REFERENCES.md) — Zero-click studies, click-per-1k data, AI overview stats (SparkToro, eMarketer, SEO Bazooka, Innerspark).
- [Content branch](https://github.com/nkllon/zero-click/tree/content) — All data, notes, and supporting material (branch `content`).

Tied into the broader picture: [internet-biz corpus](https://github.com/nkllon) — click-for-dollars vs walled gardens, Gen AI erosion of the discovery layer, and where the value goes when the click goes away.
